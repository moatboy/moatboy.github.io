...
{: .important }
* **Current Market Price (as of 7/21/2024):** ~$97.8 billion.  ADP appears to be slightly **overvalued** relative to its intrinsic value. {: .note }Given the uncertainty and risks associated with its financial outlook and ongoing lawsuits, a significant margin of safety is required before investing.
